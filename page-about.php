...
<main>
    ...
    <div class="main_inner">
        ...
        <article class="contents_width">
            ...
            <section class="mb_80">
                ...
                <div class="yuru_introduction">
                    <p class="yuru_introduction_txt mb_40">
                        「＃ゆるへんろ」とは、「発心の地」徳島をゆったりと1日で巡れるコースを紹介しています。<br><br>
            ...
            <div class="mb_80"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/hanaline.png" alt="花ライン"></div>
                ...
                <div class="yuru_txt">
                    ...
                    <div class="mb_40 js-fadeUp">
                        <p class="small_cap_independent mb_40 js-fadeUp">
                            約1200年前、弘法大師（空海）が自らの修行、そして人々を災いから救うために開いた四国八十八ケ所のお寺を巡る旅のことです。
                ...
                <div id="jump_to_about">
                    ...
                    <div class="ema">
                        ...
                        <div class="mb_40">
                            ...
                            <ul class="ul_independent mb_40 js-fadeUp">
                                <li>境内は基本的に左側通行</li>
                                <li>橋の上では杖をつかない</li>
                                <li>お賽銭は投げ入れない</li>
                                <li>トイレに輪袈裟・納経帳・数珠などは持ち込まない　（白衣は大丈夫）</li>
                                <li>お接待を受けたらお断りしない　（南大師遍照金剛と３回お唱えし、納札を渡す）</li>
                            </ul>
                        </div>
                    ...
                    <div class="procedure">
                        <div class="picto">
                            ...
                            <div class="notes">
                                ...
                                <div class="js-fadeUp">
                                    <p>お寺に到着したら、身なりを整えて門前の左側に立ち、仏様とお大師様へ一礼します。</p>
                                </div>
                            </div>
                        </div>
                        <div class="picto">
                            ...
                            <div class="notes">
                                ...
                                <div class="js-fadeUp">
                                    <p>手水場で柄杓（ひしゃく）に水を汲み、左、右の順で手を清めます。次に水を左手に溜め、口をすすいでから、柄杓を立てて残りの水で柄を洗い流します。</p>
                                </div>
                            </div>
                        </div>
                        <div class="picto">
                            ...
                            <div class="notes">
                                ...
                                <div class="js-fadeUp">
                                    <p>鐘がつけるお寺では、参拝の前に鐘をつきます。もしつき忘れても、帰りはつかないのがマナーです。お寺によっては鐘をつけないところもあるので、確認しましょう。</p>
                                </div>
                            </div>
                        </div>
                        <div class="picto">
                            ...
                            <div class="notes">
                                ...
                                <ol class="ol_independent js-fadeUp">
                                    <li>ロウソク1本と線香3本をあげます</li>
                                ...
                                <div class="js-fadeUp">
                                    <p>手順は本堂・大師堂ともに同じです。本堂→大師堂の順にお参りするのが
                                        一般的ですが、本堂が混んでいるときは大師堂から先にお参りしても大丈夫です。</p>
                                </div>
                            </div>
                        </div>
                        <div class="picto">
                            ...
                            <div class="notes">
                                ...
                                <div class="js-fadeUp">
                                    <p>納経帳に墨書と御朱印をいただきます。納経料は３００円です。
                                        2回目以上のお参りの場合、納経帳を新調する必要はなく、前回の御朱印の上に重ねていただきます。</p>
                                </div>
                            </div>
                        </div>
                        <div class="picto">
                            ...
                            <div class="notes">
                                <p class="emphasis">山門で一礼</p>
                                <div class="js-fadeUp">
                                    <p>身支度を整え、忘れ物がないか確認します。山門で合掌したら、お大師様に感謝の気持ちを込めて一礼し、境内を出ます。</p>
                                </div>
                            </div>
                        </div>
                    </div>
