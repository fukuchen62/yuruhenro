...
<main>
    ...
    <article class="main_inner">
        <section class="contents_width">
            <!-- 施設名 -->
            <div class="h2_box">
                <h2 class="h2_bg"><?php the_field('f_name'); ?></h2>
            </div>
